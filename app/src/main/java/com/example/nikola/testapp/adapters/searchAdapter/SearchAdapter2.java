...
import com.example.nikola.testapp.fragments.SearchFragment2;
...
public class SearchAdapter2 extends  RecyclerView.Adapter<SearchAdapter2.MyViewHolder> {
    ...
    public SearchAdapter2(Context context, FragmentManager fragmentManager, ArrayList<TeamCategory> mCartList) {
    ...
    @Override
    public SearchAdapter2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_category_2, parent, false);

        return new SearchAdapter2.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(SearchAdapter2.MyViewHolder holder, final int position) {
    ...
    private void bindNewsItem(SearchAdapter2.MyViewHolder holder, final int position) {
